...
function showErrorMessage(message = 'Something went wrong!') {
    Swal.fire({
        icon: 'error',
        title: 'Oops...',
        text: message.responseText !== undefined ? message.responceText : message,
        customClass: {
            confirmButton: "btn btn-primary"
        }
    });
...
$(document).ready(function () {
    ...
    //TinyMCE
    // This Condition For Apply TinyMCE Only In Views That Contains Elements With This Class [js-tinymce]
    if ($('.js-tinymce').length > 0) 
    {
    ...
    //Hanlde signout
    $('body').delegate('.js-signout', 'click', function () {
        $('#SignOut').submit();
    });
});