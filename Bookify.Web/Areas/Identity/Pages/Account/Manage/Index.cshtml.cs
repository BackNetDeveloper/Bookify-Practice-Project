...
namespace Bookify.Web.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public class InputModel
        {
			...
			///     directly from your code. This API may change or be removed in future releases.
			/// </summary>
			[Required, MaxLength(100, ErrorMessage = CustomErrorMsg.MaxLength), Display(Name = "Full Name"),
			  RegularExpression(RegexPatterns.CharactersOnly_Eng, ErrorMessage = CustomErrorMsg.OnlyEnglishLetters)]
			public string FullName { get; set; } = null!;

			[Phone]
			[Display(Name = "Phone number"), MaxLength(11, ErrorMessage = CustomErrorMsg.MaxLength),
				RegularExpression(RegexPatterns.MobileNumber, ErrorMessage = CustomErrorMsg.InvalidMobileNumber)]
